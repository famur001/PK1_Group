...
public class Audio extends Medium implements Serializable {
	...
	public void druckeDaten(OutputStream stream) {
		...
		pw.printf("Id = %d \"%s\" von %s aus %d Spieldauer %d sek.%n", super.getId(),  super.getTitel(), this.interpret,  super.getJahr(), this.dauer);
		pw.flush();
	}
	...
	public String toString() {
		return String.format("Id = %d \"%s\" von %s aus %d Spieldauer %d sek.", super.getId(),  super.getTitel(), this.interpret,  super.getJahr(), this.dauer);
	}
