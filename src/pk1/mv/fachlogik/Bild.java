...
public class Bild extends Medium implements Serializable {
	...
	public void druckeDaten(OutputStream stream) {
		...
		pw.printf( "ID = %d \"%s\" aufgenommen im Jahr %d in %s%n", super.getId(), super.getTitel(), super.getJahr(),this.ort );
		pw.flush();
	}
	...
	public String toString() {
		return String.format( "ID = %d \"%s\" aufgenommen im Jahr %d in %s", super.getId(), super.getTitel(), super.getJahr(),this.ort );
	}
